...
<section id="services" class="bg-[#FDFDFC] py-16 sm:py-20 lg:py-28 border-b border-[#0B332B]/8">
    <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-3">

            {{-- Card 1 — Petroleum Supply & Trading --}}
            <div
                class="group bg-white rounded-3xl p-5 sm:p-6 border border-[#0B332B]/10 hover:border-[#F5850F] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                <div class="space-y-2">
                    <div class="relative h-44 sm:h-48 rounded-2xl overflow-hidden bg-[#0B332B]">
                        {{-- Petroleum storage tanks / depot --}}
                        <img src="https://images.pexels.com/photos/18468420/pexels-photo-18468420.jpeg?auto=compress&cs=tinysrgb&w=600&q=85"
                            loading="lazy" alt="Petroleum Supply & Trading"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                        <span
                            class="absolute top-3 left-3 bg-[#0B332B]/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-[#F5850F]">
                            01 · Petroleum Supply
                        </span>
                    </div>

                    <h3
                        class="font-display font-bold text-[#0B332B] text-lg sm:text-xl group-hover:text-[#F5850F] transition-colors">
                    ...
                    <ul class="space-y-1.5 pt-2 text-[13px] font-semibold text-[#0B332B]/80">
                        ...
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>Aviation Jet A-1 &amp; DPK</li>
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>Unadulterated Quality Specs</li>
                    </ul>
                </div>

                <div class="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#0B332B]/8 flex items-center justify-between">
                    <a href="{{ route('services.petroleum') }}"
                        class="text-xs font-bold text-[#0B332B] hover:text-[#F5850F] transition-colors">
                        Details →
                    </a>
                    <button data-open-quote="Petroleum Supply & Trading"
                        class="px-3.5 py-1.5 rounded-full bg-[#F5850F]/10 hover:bg-[#F5850F] text-[#F5850F] hover:text-white text-[11px] font-bold transition-all cursor-pointer">
                        Get Quote
                    </button>
                </div>
            </div>
            ...
            <div
                ...
                <div class="space-y-2">
                    <div class="relative h-44 sm:h-48 rounded-2xl overflow-hidden bg-[#0B332B]">
                        ...
                        <img src="https://images.pexels.com/photos/38404178/pexels-photo-38404178.jpeg?auto=compress&cs=tinysrgb&w=600&q=85"
                            alt="Logistics & Fleet Haulage"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                        <span
                            class="absolute top-3 left-3 bg-[#0B332B]/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-[#F5850F]">
                            02 · Logistics
                    ...
                    <ul class="space-y-1.5 pt-2 text-[13px] font-semibold text-[#0B332B]/80">
                        ...
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>36-State Delivery Fleet</li>
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>24/7 Emergency Dispatch</li>
                    </ul>
                </div>
                ...
                <div class="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#0B332B]/8 flex items-center justify-between">
                    ...
                    <button data-open-quote="Logistics & Distribution"
                        class="px-3.5 py-1.5 rounded-full bg-[#F5850F]/10 hover:bg-[#F5850F] text-[#F5850F] hover:text-white text-[11px] font-bold transition-all cursor-pointer">
                        Get Quote
                    </button>
                </div>
            ...
            <div
                ...
                <div class="space-y-2">
                    <div class="relative h-44 sm:h-48 rounded-2xl overflow-hidden bg-[#0B332B]">
                        ...
                        <img src="https://images.pexels.com/photos/8487393/pexels-photo-8487393.jpeg?auto=compress&cs=tinysrgb&w=600&q=85"
                            loading="lazy" alt="Engineering Services"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                        <span
                            class="absolute top-3 left-3 bg-[#0B332B]/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-[#F5850F]">
                            03 · Engineering
                    ...
                    <ul class="space-y-1.5 pt-2 text-[13px] font-semibold text-[#0B332B]/80">
                        ...
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>Asset Integrity Inspections</li>
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>Technical Equipment Supply</li>
                    </ul>
                </div>
                ...
                <div class="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#0B332B]/8 flex items-center justify-between">
                    ...
                    <button data-open-quote="Engineering & Industrial"
                        class="px-3.5 py-1.5 rounded-full bg-[#F5850F]/10 hover:bg-[#F5850F] text-[#F5850F] hover:text-white text-[11px] font-bold transition-all cursor-pointer">
                        Get Quote
                    </button>
                </div>
            ...
            <div
                ...
                <div class="space-y-2">
                    <div class="relative h-44 sm:h-48 rounded-2xl overflow-hidden bg-[#0B332B]">
                        ...
                        <img src="https://images.pexels.com/photos/5298215/pexels-photo-5298215.jpeg?auto=compress&cs=tinysrgb&w=600&q=85"
                            loading="lazy" alt="Energy Infrastructure"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                        <span
                            class="absolute top-3 left-3 bg-[#0B332B]/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-[#F5850F]">
                            04 · Infrastructure
                    ...
                    <ul class="space-y-1.5 pt-2 text-[13px] font-semibold text-[#0B332B]/80">
                        ...
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>Retail Fuel Station Setup</li>
                        <li class="flex items-center gap-2"><span
                                class="w-1.5 h-1.5 rounded-full bg-[#F5850F]"></span>LPG Depot &amp; Skid Plants</li>
                    </ul>
                </div>
                ...
                <div class="pt-5 sm:pt-6 mt-5 sm:mt-6 border-t border-[#0B332B]/8 flex items-center justify-between">
                    ...
                    <button data-open-quote="Energy Infrastructure"
                        class="px-3.5 py-1.5 rounded-full bg-[#F5850F]/10 hover:bg-[#F5850F] text-[#F5850F] hover:text-white text-[11px] font-bold transition-all cursor-pointer">
                        Get Quote
                    </button>
                </div>
