  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    ...
    <div class="text-center max-w-3xl mx-auto mb-10 sm:mb-14 lg:mb-20 space-y-3 sm:space-y-4">
      ...
      <p class="text-[#2A2A2A]/70 text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl mx-auto">
        Explore the key reasons industrial clients and filling stations choose Alms Oil as their trusted energy supply partner.
      </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-8 items-stretch">
      ...
      <div class="flex flex-col gap-5 sm:gap-6 lg:gap-8 justify-between">
        ...
        {{-- Top-Left Card --}}
        <div class="bg-[#F2ECE4] p-6 sm:p-8 rounded-3xl border border-[#0B332B]/10 shadow-sm flex flex-col justify-between space-y-6">
          <p class="text-[#2A2A2A]/75 text-xs sm:text-sm lg:text-base leading-relaxed">
            Our unwavering quality assurance ensures you receive top-purity petroleum products, always meeting your exact industrial standards.
          </p>
          <div>
            <p class="font-display text-3xl sm:text-4xl font-extrabold text-[#0B332B] leading-none">99.8%</p>
            <p class="text-xs sm:text-sm font-bold text-[#0B332B] mt-1">Product Purity &amp; Spec Guarantee</p>
          </div>
        </div>
        ...
        <div class="relative rounded-3xl overflow-hidden shadow-xl border-2 border-white h-[240px] sm:h-[280px]">
          ...
          <div class="absolute bottom-4 left-4 right-4 text-white">
            <span class="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#F5850F]">Quality Assurance</span>
      ...
      <div class="bg-[#0B332B] text-white rounded-3xl p-6 sm:p-8 shadow-2xl border-2 sm:border-4 border-white flex flex-col justify-between relative overflow-hidden min-h-[460px] sm:min-h-[500px]">
        
        <div class="absolute top-0 right-0 w-64 h-64 bg-[#F5850F]/15 rounded-full blur-2xl pointer-events-none"></div>
        ...
        <div class="relative my-4 sm:my-6 rounded-2xl overflow-hidden shadow-lg h-[200px] sm:h-[250px] border border-white/20">
          ...
          <div class="absolute top-3 right-3 bg-white/20 backdrop-blur-md px-3 py-1 rounded-full text-[9px] sm:text-[10px] font-bold text-white border border-white/20">
            GPS Fleet Telemetry
          </div>
        </div>
        ...
        <div class="relative z-10">
          <p class="text-xs sm:text-sm text-white/80 leading-relaxed">
            You can rely on us to keep your manufacturing plant, generators, and fleet running smoothly without costly delays.
          </p>
        </div>
      ...
      <div class="flex flex-col gap-5 sm:gap-6 lg:gap-8 justify-between">
        ...
        <div class="relative rounded-3xl overflow-hidden shadow-xl border-2 border-white h-[240px] sm:h-[280px]">
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-[#0B332B]/85 via-transparent to-transparent"></div>
          <div class="absolute bottom-4 left-4 right-4 text-white">
            <span class="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#F5850F]">Bulk Storage Infrastructure</span>
            <p class="text-xs font-bold mt-0.5">Strategic Tank Farm Terminals</p>
          </div>
        </div>

        {{-- Bottom-Right Card --}}
        <div class="bg-[#EAEAF6] p-6 sm:p-8 rounded-3xl border border-[#0B332B]/10 shadow-sm flex flex-col justify-between space-y-6">
          <div>
            <p class="font-display text-3xl sm:text-4xl font-extrabold text-[#0B332B] leading-none">850M+</p>
          ...
          <p class="text-[#2A2A2A]/75 text-xs sm:text-sm leading-relaxed">
            Join countless satisfied corporate and industrial customers who have relied on our consistent, expert energy supply nationwide.
          </p>
        </div>
