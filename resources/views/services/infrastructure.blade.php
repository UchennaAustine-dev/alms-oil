...
@section('description', 'Design, build, and management of petroleum storage and distribution infrastructure — tank farms, modular filling stations, and private depot construction across Nigeria.')
...
<section class="relative overflow-hidden bg-[#0B332B]" style="min-height:82vh">
  <div class="absolute inset-0 z-0">
    <img src="https://images.pexels.com/photos/3850512/pexels-photo-3850512.jpeg?auto=compress&cs=tinysrgb&w=1600&q=85"
         alt="Oil storage tank farm"
    ...
    <div class="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
      <div>
        <div class="flex items-center gap-2.5 mb-5 sm:mb-6">
          ...
          <span class="text-[10px] font-bold tracking-[0.32em] uppercase text-[#F5850F]">04 — Our Services</span>
        </div>
        ...
        <p class="text-white/70 text-sm sm:text-base lg:text-lg leading-relaxed mb-7 sm:mb-8 max-w-lg">
          Turnkey design, construction, and management of petroleum storage and distribution infrastructure — from tank farms to modular filling stations across Nigeria.
        </p>
      ...
      <div class="space-y-3">
        <div class="backdrop-blur-md bg-white/8 border border-white/15 rounded-3xl p-5 sm:p-6">
          <p class="text-white/75 text-sm sm:text-base leading-relaxed">
            We deliver complete infrastructure solutions for petroleum businesses — whether you're building a new depot, expanding a tank farm, or setting up a retail fuel station from the ground up.
          </p>
        </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-14">
      <div>
        <div class="flex items-center gap-2.5 mb-3">
          ...
          <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-[#F5850F]">What We Build</span>
        </div>
        <h2 class="font-display font-bold text-[#0B332B] leading-tight tracking-tight" style="font-size:clamp(1.8rem,3.5vw,3rem)">Infrastructure We Deliver</h2>
      </div>
      <p class="text-sm text-[#2A2A2A]/55 max-w-xs sm:text-right leading-relaxed">Engineered to last, built to the highest Nigerian and international standards.</p>
    </div>

    @php
      $solutions = [
        ['Tank Farm Development','Above-ground storage tank design and construction for AGO, PMS, and LPG. Capacities from 50KL to 10,000KL with full containment bunding.',
         '<path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>',
         'bg-[#0B332B]'],
        ['Filling Station Construction','Turnkey modular fuel retail stations — canopy, forecourt, underground tanks, dispensers, and complete management systems.',
         '<path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>',
         'bg-[#F5850F]'],
        ['Private Depot Build-out','End-to-end private petroleum depot development from site selection and design to construction and commissioning.',
         '<path stroke-linecap="round" stroke-linejoin="round" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"/>',
         'bg-[#0B332B]'],
        ['Depot Management','Operational management of third-party depots — staffing, inventory control, reconciliation, and safety compliance.',
         '<path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>',
         'bg-[#F5850F]'],
        ['LPG Facilities','Bottling plant design, storage cylinder parks, and LPG reticulation systems for industrial and commercial sites.',
         '<path stroke-linecap="round" stroke-linejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/>',
         'bg-[#0B332B]'],
        ['Pipeline & Flow Systems','Transfer pipelines, manifold systems, metering skids, and pump stations for depot and terminal operations.',
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="text-center mb-10 sm:mb-14">
      <div class="flex items-center justify-center gap-2.5 mb-3">
        <div class="w-4 h-px bg-[#F5850F]"></div>
        <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-[#F5850F]">Project Lifecycle</span>
        <div class="w-4 h-px bg-[#F5850F]"></div>
      </div>
      <h2 class="font-display font-bold text-[#0B332B] tracking-tight" style="font-size:clamp(1.7rem,3vw,2.6rem)">From Concept to Commissioning</h2>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative">
      ...
      @foreach([
        ['01','Feasibility & Design','Site assessment, regulatory review, FEED documentation, and engineering design package.'],
        ['02','Approvals & Permits','DPR, NMDPRA, local government, and environmental permits — we manage the full approval chain.'],
        ['03','Construction & Build','Civil works, steel fabrication, mechanical installation, and instrumentation by certified teams.'],
        ['04','Testing & Handover','Pre-commissioning checks, capacity testing, operator training, and as-built documentation.'],
      ] as [$num,$title,$desc])
        <div class="srv-reveal relative z-10 flex flex-col items-center text-center sm:items-start sm:text-left lg:items-center lg:text-center">
          <div class="w-16 h-16 rounded-2xl bg-[#0B332B] text-white flex flex-col items-center justify-center mb-4 shrink-0 shadow-lg">
            <span class="text-[9px] font-black uppercase tracking-widest text-[#F5850F]">Phase</span>
...
{{-- FEATURE IMAGE SPLIT --}}
<section class="bg-[#F8FAFC] py-14 sm:py-20 lg:py-24 border-t border-[#0B332B]/8">
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
      <div class="relative srv-reveal">
        <div class="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-[#0B332B]/20 border-4 border-white">
          <img src="https://images.pexels.com/photos/247763/pexels-photo-247763.jpeg?auto=compress&cs=tinysrgb&w=900&q=85"
               alt="Tank farm construction"
        ...
        <div class="absolute -bottom-4 -right-2 sm:-right-6 z-10 flex items-center gap-3 bg-white px-4 py-3 rounded-2xl shadow-xl border border-[#0B332B]/10">
          ...
          <div>
            <p class="text-[10px] font-extrabold uppercase tracking-wider text-[#F5850F]">Full Turnkey</p>
            <p class="text-xs font-black text-[#0B332B]">Design to Handover</p>
          </div>
        </div>
      </div>
      ...
      <div class="srv-reveal">
        <div class="flex items-center gap-2.5 mb-4">
          <div class="w-4 h-px bg-[#F5850F]"></div>
          <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-[#F5850F]">Why Choose Us</span>
        </div>
        <h2 class="font-display font-bold text-[#0B332B] leading-tight tracking-tight mb-8" style="font-size:clamp(1.7rem,3vw,2.6rem)">
          Built right the first time,<br/>every time.
        </h2>
        <div class="space-y-4">
          @foreach([
            ['DPR-Licensed Construction','All infrastructure projects are designed and executed by DPR-certified contractors under Alms Oil project management.'],
            ['Regulatory Navigation','We manage the entire permits and approvals chain — NMDPRA, DPR, state environmental agencies, and local government.'],
            ['QHSE Integration','Quality, health, safety, and environment standards are embedded at every project phase — not added as an afterthought.'],
            ['On-Time Delivery','Our project management framework tracks milestones in real time. We are transparent about timelines and accountable for delivery.'],
          ] as [$title,$desc])
            <div class="flex gap-4 p-4 sm:p-5 rounded-2xl bg-white border border-[#0B332B]/8 hover:border-[#F5850F]/30 hover:bg-[#F5850F]/[0.02] transition-all duration-200">
...
{{-- OTHER SERVICES --}}
<section class="bg-white py-12 sm:py-16 border-t border-[#0B332B]/8">
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      @foreach([
        ...
        <a href="{{ $r }}" class="group flex items-center justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-[#F8FAFC] border border-[#0B332B]/8 hover:border-[#F5850F]/40 hover:shadow-md transition-all duration-200">
          <div>
...
<section class="relative overflow-hidden bg-[#0B332B] py-14 sm:py-20">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
      <div>
        <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-[#F5850F] mb-3">Planning a Project?</p>
