...
@section('description',
    'Technical engineering services for the petroleum and energy sector — equipment installation,
    HSE compliance, pipeline integrity, and industrial fabrication across Nigeria.')
    ...
    <section class="relative overflow-hidden bg-alms-green" style="min-height:82vh">
        <div class="absolute inset-0 z-0">
            <img src="https://images.pexels.com/photos/7155795/pexels-photo-7155795.jpeg?auto=compress&cs=tinysrgb&w=1600&q=85"
                alt="Industrial engineer at work" class="w-full h-full object-cover object-center"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 flex flex-col justify-between"
            ...
            <div class="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
                <div>
                    ...
                    <p class="text-white text-base lg:text-lg leading-relaxed mb-7 sm:mb-8 max-w-lg">
                        End-to-end technical services for the energy sector — equipment installation, safety audits,
                        pipeline integrity checks, and industrial maintenance across Nigeria.
                    </p>
                ...
                <div class="space-y-3">
                    <div class="backdrop-blur-md bg-white/8 border border-white/15 rounded-3xl p-5 sm:p-6">
                        <p class="text-white text-base">
                            Our certified engineers deliver turnkey technical solutions for petroleum facilities — from
                            first installation through to long-term maintenance and HSE compliance management.
                        </p>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-14">
                <div>
                    ...
                    <h2 class="font-display font-bold text-alms-green leading-tight tracking-tight"
                        style="font-size:clamp(1.8rem,3.5vw,3rem)">Engineering Capabilities</h2>
                </div>
                <p class="text-base text-alms-charcoal/55 max-w-xs sm:text-right">Technical expertise covering
                    the full lifecycle of petroleum assets.</p>
            </div>
            ...
            @php
                $services = [
                    [
                        ...
                        'Pump stations, dispensers, flow meters, and tank instrumentation — supply, delivery, and full installation.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Maintenance & Repairs',
                        'Scheduled preventive maintenance contracts and emergency call-out for all energy infrastructure assets.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z"/>',
                        'bg-alms-orange',
                    ],
                    [
                        'Safety & HSE Compliance',
                        'Site HSE audits, DPR inspection readiness, fire suppression systems, and spill containment solutions.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Pipeline Integrity',
                        'Pipeline inspection, leak detection, cathodic protection, and structural integrity assessment services.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>',
                        'bg-alms-orange',
                    ],
                    [
                        'Electrical & Instrumentation',
                        'Power distribution panels, ATEX-rated electrical systems, and process instrumentation for hazardous zones.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Industrial Procurement',
                        'OEM and equivalent spare parts supply for energy infrastructure — sourced, verified, and delivered fast.',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
                <div class="srv-reveal">
                    ...
                    <div class="space-y-4">
                        @foreach ([['Site Assessment', 'Every project starts with a full on-site evaluation — identifying hazards, requirements, and optimal technical approach before any work begins.'], ['Certified Execution', 'All works carried out by DPR-certified engineers with active HSE protocols. Zero-compromise on safety standards.'], ['Commissioning & Handover', 'Full system testing, operator training, and documentation package delivered at project completion.'], ['Post-Completion Support', 'Optional long-term maintenance contracts ensure your assets remain in peak operational condition.']] as [$title, $desc])
                            <div
                ...
                <div class="relative srv-reveal">
                    ...
                    <div
                        class="absolute -bottom-4 -left-2 sm:-left-6 z-10 flex items-center gap-3 bg-white px-4 py-3 rounded-2xl shadow-xl border border-alms-green/10">
                        <div class="flex items-center justify-center w-9 h-9 rounded-xl bg-alms-green/8">
                            <svg class="w-4 h-4 text-alms-green" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                stroke-width="2">
                        ...
                        <div>
                            <p class="text-[10px] font-extrabold uppercase tracking-wider text-alms-orange">24hr Response
                            </p>
    ...
    <section class="bg-[#F8FAFC] py-12 sm:py-16 border-t border-alms-green/8">
        <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                @foreach ([['Petroleum Supply', 'AGO, PMS, DPK & specialty products.', route('services.petroleum')], ['Logistics & Haulage', 'GPS-tracked fleet, nationwide delivery.', route('services.logistics')], ['Energy Infrastructure', 'Tank farms, depots & filling stations.', route('services.infrastructure')]] as [$t, $s, $r])
                    <a href="{{ $r }}"
    ...
    <section class="relative overflow-hidden bg-alms-green py-14 sm:py-20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                <div>
                    <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-alms-orange mb-3">Engineering Enquiry?
                    </p>
