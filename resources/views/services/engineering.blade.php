    ...
    <div class="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
      <div>
        <div class="flex items-center gap-2.5 mb-5 sm:mb-6">
          ...
          <span class="text-[10px] font-bold tracking-[0.32em] uppercase text-[#F5850F]">03 — Our Services</span>
        </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-14">
      <div>
        <div class="flex items-center gap-2.5 mb-3">
          ...
          <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-[#F5850F]">What We Do</span>
        </div>
        <h2 class="font-display font-bold text-[#0B332B] leading-tight tracking-tight" style="font-size:clamp(1.8rem,3.5vw,3rem)">Engineering Capabilities</h2>
      </div>
      <p class="text-sm text-[#2A2A2A]/55 max-w-xs sm:text-right leading-relaxed">Technical expertise covering the full lifecycle of petroleum assets.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
      <div class="srv-reveal">
        <div class="flex items-center gap-2.5 mb-4">
          <div class="w-4 h-px bg-[#F5850F]"></div>
          <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-[#F5850F]">Our Approach</span>
        </div>
      ...
      <div class="relative srv-reveal">
        ...
        <div class="absolute -bottom-4 -left-2 sm:-left-6 z-10 flex items-center gap-3 bg-white px-4 py-3 rounded-2xl shadow-xl border border-[#0B332B]/10">
          <div class="flex items-center justify-center w-9 h-9 rounded-xl bg-[#0B332B]/8">
            <svg class="w-4 h-4 text-[#0B332B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
          </div>
          <div>
            <p class="text-[10px] font-extrabold uppercase tracking-wider text-[#F5850F]">24hr Response</p>
            <p class="text-xs font-black text-[#0B332B]">Emergency call-out ready</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="relative overflow-hidden bg-[#0B332B] py-14 sm:py-20">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
      <div>
        <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-[#F5850F] mb-3">Engineering Enquiry?</p>
