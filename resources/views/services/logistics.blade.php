@extends('layouts.app')
@section('title', 'Logistics & Distribution | Alms Oil Nigeria Limited')
...
<div class="border-b border-[#efefef]">
  <div class="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-5 flex items-center gap-2 text-[13px] text-[#999]">
    ...
    <span>/</span>
    <span class="text-[#0f0f0f]">Logistics &amp; Distribution</span>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
      <div>
        <div class="flex items-center gap-3 mb-6">
          ...
          <span class="text-[11px] font-semibold tracking-[0.2em] uppercase text-[#C8922A]">02 — Our Services</span>
        </div>
        <h1 class="font-display font-bold text-[#0f0f0f] leading-[1.05] tracking-tight mb-6"
            style="font-size:clamp(2rem,4vw,3.25rem)">Logistics &amp; Distribution</h1>
        <p class="text-[#555] text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
          End-to-end petroleum product haulage across Nigeria's 36 states. GPS-tracked fleet, depot-to-site delivery, and dedicated account management for high-volume clients.
        </p>
      ...
      <div class="space-y-6">
        @foreach([
          ['GPS Fleet Tracking','Real-time location visibility on every tanker. Live ETAs and delivery confirmation from loading to site.'],
          ['Nationwide Coverage','Active haulage routes in all 36 states and FCT. Same-day dispatch in Lagos & Abuja.'],
          ['24/7 Operations','Round-the-clock dispatch coordination and emergency supply capability for critical operations.'],
          ['Volume Flexibility','Mini tankers (10,000 L) through to bulk multi-truck convoys (500,000+ L). Structured for your needs.'],
        ] as [$title,$desc])
