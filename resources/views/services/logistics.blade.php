...
@section('description', 'GPS-tracked petroleum haulage across all 36 Nigerian states. End-to-end depot-to-site delivery
    with 24/7 dispatch coordination for high-volume clients.')
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-alms-green" style="min-height:82vh">
        <div class="absolute inset-0 z-0">
            <img src="https://images.pexels.com/photos/4320468/pexels-photo-4320468.jpeg?auto=compress&cs=tinysrgb&w=1600&q=85"
                alt="Petroleum tanker truck on highway" class="w-full h-full object-cover object-center"
            ...
            <div class="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
                <div>
                    ...
                    <p class="text-white text-base lg:text-lg leading-relaxed mb-7 sm:mb-8 max-w-lg">
                        End-to-end petroleum haulage across Nigeria's 36 states. GPS-tracked tankers, depot-to-site
                        delivery, and dedicated account management for high-volume clients.
                    </p>
                ...
                <div class="space-y-3">
                    <div class="backdrop-blur-md bg-white/8 border border-white/15 rounded-3xl p-5 sm:p-6">
                        <p class="text-white text-base">
                            Our fleet operates round-the-clock, ensuring your fuel supply chain never stops — whether you
                            need a single mini-tanker or a multi-truck convoy for large industrial operations.
                        </p>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-14">
                <div>
                    ...
                    <h2 class="font-display font-bold text-alms-green leading-tight tracking-tight"
                        style="font-size:clamp(1.8rem,3.5vw,3rem)">Built for Nigeria's Roads</h2>
                </div>
                <p class="text-base text-alms-charcoal/55 max-w-xs sm:text-right ">From Lagos to Maiduguri — we
                    cover every route, every time.</p>
            </div>
            ...
            @php
                $caps = [
                    [
                        'GPS Fleet Tracking',
                        'Real-time visibility on every tanker. Live ETAs and delivery confirmation from loading point to final site.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Nationwide Routes',
                        'Active haulage in all 36 states and FCT. Same-day dispatch in Lagos, Abuja, and Port Harcourt.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>',
                        'bg-alms-orange',
                    ],
                    [
                        '24/7 Operations',
                        'Round-the-clock dispatch coordination and emergency supply capability for critical industrial operations.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Volume Flexibility',
                        'Mini tankers (10,000 L) to bulk multi-truck convoys (500,000+ L). Structured for any scale.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>',
                        'bg-alms-orange',
                    ],
                    [
                        'Dedicated Account Manager',
                        'A single point of contact who knows your routes, your schedule, and your compliance requirements.',
                        '<path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>',
                        'bg-alms-green',
                    ],
                    [
                        'Safety & Compliance',
                        'FRSC-compliant fleet, certified drivers, and mandatory HSE protocols on every delivery run.',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            <div class="text-center mb-10 sm:mb-14">
                ...
                <h2 class="font-display font-bold text-alms-green tracking-tight"
                    style="font-size:clamp(1.7rem,3vw,2.6rem)">From Order to Delivery</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative">
                ...
                @foreach ([['01', 'Submit Request', 'Use our quote form or call directly to specify product, volume, and delivery location.'], ['02', 'Route Planning', 'Our logistics team plans the optimal route and assigns a GPS-enabled tanker to your order.'], ['03', 'Loading & Dispatch', 'Product is loaded from a certified depot, sealed, and dispatched with real-time tracking active.'], ['04', 'Delivery & Sign-off', 'Your team receives delivery at site. Certificate of delivery and quantity slip issued on arrival.']] as [$num, $title, $desc])
                    <div
                        ...
                        <div
                            ...
                            <span class="text-[9px] font-black uppercase tracking-widest text-alms-orange">Step</span>
    ...
    <section class="bg-[#F8FAFC] py-12 sm:py-16 border-t border-alms-green/8">
        <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                @foreach ([['Petroleum Supply', 'AGO, PMS, DPK & specialty products.', route('services.petroleum')], ['Engineering Services', 'Installation, maintenance & HSE compliance.', route('services.engineering')], ['Energy Infrastructure', 'Tank farms, depots & filling stations.', route('services.infrastructure')]] as [$t, $s, $r])
                    <a href="{{ $r }}"
    ...
    <section class="relative overflow-hidden bg-alms-green py-14 sm:py-20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                <div>
                    <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-alms-orange mb-3">Need a Logistics
                        Partner?</p>
