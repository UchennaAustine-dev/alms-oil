    ...
    <div class="py-10 sm:py-14 lg:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
      <div>
        <div class="flex items-center gap-2.5 mb-5 sm:mb-6">
          ...
          <span class="text-[10px] font-bold tracking-[0.32em] uppercase text-alms-orange">02 — Our Services</span>
        </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-14">
      <div>
        <div class="flex items-center gap-2.5 mb-3">
          ...
          <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-alms-orange">Fleet Capabilities</span>
        </div>
        <h2 class="font-display font-bold text-alms-green leading-tight tracking-tight" style="font-size:clamp(1.8rem,3.5vw,3rem)">Built for Nigeria's Roads</h2>
      </div>
      <p class="text-sm text-alms-charcoal/55 max-w-xs sm:text-right leading-relaxed">From Lagos to Maiduguri — we cover every route, every time.</p>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="text-center mb-10 sm:mb-14">
      <div class="flex items-center justify-center gap-2.5 mb-3">
        <div class="w-4 h-px bg-alms-orange"></div>
        <span class="text-[10px] font-bold tracking-[0.28em] uppercase text-alms-orange">The Process</span>
        <div class="w-4 h-px bg-alms-orange"></div>
      </div>
      <h2 class="font-display font-bold text-alms-green tracking-tight" style="font-size:clamp(1.7rem,3vw,2.6rem)">From Order to Delivery</h2>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative">
      ...
      @foreach([
        ...
        <div class="srv-reveal relative z-10 flex flex-col items-center text-center sm:items-start sm:text-left lg:items-center lg:text-center">
          <div class="w-16 h-16 rounded-2xl bg-alms-green text-white flex flex-col items-center justify-center mb-4 shrink-0 shadow-lg">
...
<section class="relative overflow-hidden bg-alms-green py-14 sm:py-20">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
      <div>
        <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-alms-orange mb-3">Need a Logistics Partner?</p>
