<section class="relative overflow-hidden bg-[#0B332B]" style="min-height:92vh">
  <div class="absolute inset-0 z-0">
    <img src="https://images.pexels.com/photos/2101137/pexels-photo-2101137.jpeg?auto=compress&cs=tinysrgb&w=1600"
         alt="Petroleum refinery operations"
         class="w-full h-full object-cover object-center"
         style="filter:saturate(0.7) brightness(0.45) contrast(1.08)" />
    <div class="absolute inset-0"
         style="background:linear-gradient(135deg,rgba(11,51,43,0.82) 0%,rgba(11,51,43,0.45) 50%,rgba(11,51,43,0.7) 100%)"></div>
  </div>
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 flex flex-col justify-between" style="min-height:92vh">
    ...
    <div class="py-12 sm:py-16 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-end">
      <div>
        <div class="flex items-center gap-2.5 mb-6">
          ...
          <span class="text-[10px] font-bold tracking-[0.32em] uppercase text-[#F5850F]">About Alms Oil Nigeria</span>
        </div>
        <h1 class="font-display font-bold text-white leading-[0.88] tracking-tight mb-8" style="font-size:clamp(3rem,6.5vw,6rem)">
          Nigeria's<br/>trusted<br/>
          <em class="not-italic" style="-webkit-text-stroke:1.5px rgba(245,133,15,0.7);color:transparent">petroleum</em><br/>
      ...
      <div class="space-y-4">
        <div class="backdrop-blur-md bg-white/8 border border-white/15 rounded-3xl p-6 sm:p-7">
          <p class="text-white/80 text-base sm:text-lg leading-relaxed">We connect businesses to reliable petroleum supply, logistics, and energy infrastructure — built on safety, transparency, and operational excellence across all 36 Nigerian states.</p>
        </div>
        <div class="grid grid-cols-3 gap-3">
          @foreach([['850M+','Litres Supplied',true],['36','States Covered',false],['24/7','Operations',true]] as [$v,$l,$orange])
            <div class="backdrop-blur-md {{ $orange ? 'bg-[#F5850F]/15 border-[#F5850F]/25' : 'bg-white/8 border-white/12' }} border rounded-2xl px-4 py-4 text-center">
              <p class="font-display font-black text-white leading-none mb-1" style="font-size:clamp(1.4rem,2.5vw,1.9rem)">{{ $v }}</p>
